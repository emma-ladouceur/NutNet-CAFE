...
# load model object
load("~/Dropbox/Projects/NutNet/Data/Model_Fits/multi_price.Rdata") # object name: pp.multi
...
# load model object
load("~/Dropbox/Projects/NutNet/Data/Model_Fits/multi_sp.Rdata") # object name: nn.multi
