...
dat15<-dat1[dat1$site_code %in% c('chilcas.ar'),]
#dat17<-dat1[dat1$site_code %in% c('comp.pt'),]
dat16<-dat1[dat1$site_code %in% c('cowi.ca'),]
dat17<-dat1[dat1$site_code %in% c('doane.us'),]
#dat20<-dat1[dat1$site_code %in% c('elliot.us'),]
dat18<-dat1[dat1$site_code %in% c('ethass.au'),]
dat19<-dat1[dat1$site_code %in% c('frue.ch'),]
dat20<-dat1[dat1$site_code %in% c('gilb.za'),]
dat21<-dat1[dat1$site_code %in% c('glcr.us'),]
dat22<-dat1[dat1$site_code %in% c('hall.us'),]

dat23<-dat1[dat1$site_code %in% c('hart.us'),]
#dat24<-dat1[dat1$site_code %in% c('hero.uk'),]
dat25<-dat1[dat1$site_code %in% c('hnvr.us'),]
dat26<-dat1[dat1$site_code %in% c('hopl.us'),]
dat27<-dat1[dat1$site_code %in% c('jena.de'),]
dat28<-dat1[dat1$site_code %in% c('kbs.us'),]
dat29<-dat1[dat1$site_code %in% c('kibber.in'),]
dat30<-dat1[dat1$site_code %in% c('kidman.au'),]
dat31<-dat1[dat1$site_code %in% c('kilp.fi'),]
dat32<-dat1[dat1$site_code %in% c('kiny.au'),]
dat33<-dat1[dat1$site_code %in% c('koffler.ca'),]

dat34<-dat1[dat1$site_code %in% c('konz.us'),]
dat35<-dat1[dat1$site_code %in% c('lake.us'),]
dat36<-dat1[dat1$site_code %in% c('lancaster.uk'),]
dat37<-dat1[dat1$site_code %in% c('look.us'),]
dat38<-dat1[dat1$site_code %in% c('marc.ar'),]
dat39<-dat1[dat1$site_code %in% c('mcla.us'),]
...
dat47<-dat1[dat1$site_code %in% c('ping.au'),]
dat48<-dat1[dat1$site_code %in% c('pinj.au'),]
#dat50<-dat1[dat1$site_code %in% c('podo.ec'),]
dat49<-dat1[dat1$site_code %in% c('potrok.ar'),]
#dat52<-dat1[dat1$site_code %in% c('rook.uk'),]
dat50<-dat1[dat1$site_code %in% c('saana.fi'),]
dat51<-dat1[dat1$site_code %in% c('sage.us'),]
dat52<-dat1[dat1$site_code %in% c('sava.us'),]
dat53<-dat1[dat1$site_code %in% c('sedg.us'),]

dat54<-dat1[dat1$site_code %in% c('sereng.tz'),]
dat55<-dat1[dat1$site_code %in% c('sevi.us'),]
dat56<-dat1[dat1$site_code %in% c('sgs.us'),]
dat57<-dat1[dat1$site_code %in% c('shps.us'),]
dat58<-dat1[dat1$site_code %in% c('sier.us'),]
dat59<-dat1[dat1$site_code %in% c('smith.us'),]
dat60<-dat1[dat1$site_code %in% c('spin.us'),]
dat61<-dat1[dat1$site_code %in% c('summ.za'),]
dat62<-dat1[dat1$site_code %in% c('temple.us'),]
#dat65<-dat1[dat1$site_code %in% c('trel.us'),]
dat63<-dat1[dat1$site_code %in% c('tyso.us'),]
dat64<-dat1[dat1$site_code %in% c('ufrec.us'),]

dat65<-dat1[dat1$site_code %in% c('ukul.za'),]
dat66<-dat1[dat1$site_code %in% c('unc.us'),]
dat67<-dat1[dat1$site_code %in% c('valm.ch'),]
dat68<-dat1[dat1$site_code %in% c('yarra.au'),]
...
p17 <- leap.zig(dat18,type='cafe', standardize = FALSE,raw.points = F)+ 
  annotate("text", x = mean(dat18$x.rich), y = mean(dat18$x.func), 
           label = "*",size=8)+ggtitle('ethass.au')+theme_classic()+ theme(plot.title = element_text(size=9),axis.title.x=element_blank(),axis.title.y=element_blank(),axis.text=element_text(size=6))
...
p31 <- leap.zig(dat32,type='cafe', standardize = FALSE,raw.points = F)+ 
  annotate("text", x = mean(dat32$x.rich), y = mean(dat32$x.func), 
           label = "*",size=8)+ggtitle('kiny.au')+theme_classic()+ theme(plot.title = element_text(size=9),axis.title.x=element_blank(),axis.title.y=element_blank(),axis.text=element_text(size=6))
...
grid_arrange_shared_legend(p1,p2,p3,p4,p5,p7,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p45,p46,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63,p64,p65,p66,p67,p68,p69,p70,ncol=11,nrow=7)
