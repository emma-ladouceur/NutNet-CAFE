...
# regressions together using patchwork
(fig_3a | fig_3b_r | fig_3c_r) / (fig_3d_r | fig_3e_r  | fig_3f_r ) / (fig_3_legend) +
...
# effect plots
(fig_2a_e | fig_2b_e)/(fig_3b_e | fig_3c_e)/(fig_3d_e | fig_3e_e | fig_3f_e)
